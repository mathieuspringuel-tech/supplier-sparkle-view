...
const baseSuppliers: Supplier[] = [
  ...
  { id: "12", name: "Salesforce.com", industry: "CRM & Cloud Computing", description: "Global leader in CRM, providing cloud-based sales, service, marketing, and commerce solutions. Committed to net-zero across its full value chain.", tco2e: 75.14, spend: 896620, hasTargets: true, cdp: true, category: "Purchased goods & services", synced: true, emissionFactor: 0.512, methodology: "Organisation specific", calculationMethodology: "spend", hqCountry: "US", website: "https://www.salesforce.com" },
  { id: "13", name: "SADA Systems Inc.", industry: "Cloud Consulting", description: "Google Cloud Premier Partner providing cloud computing, data analytics, machine learning, and enterprise application services.", tco2e: 18.38, spend: 219363, hasTargets: true, cdp: true, category: "Purchased goods & services", synced: true, emissionFactor: 0.389, methodology: "Organisation specific", calculationMethodology: "spend", hqCountry: "US", website: "https://www.sada.com" },
